        ...
        <div className="row content ">
          ...
          <div className="col-sm-9 mt-5 ml-10">
            <div className=" searchbaar flex flex-wrap gap-3 justify-between items-center ">
              <h4 className='heading text-3xl font-bold'>Hello Vaibhav <span className='text-4xl'></span>,</h4>
              ...
              <div className="col-sm-3">
                <div className="well flex items-center rounded-2xl">
                  ...
                  <div className='content ml-5'>
                    ...
                    <h4 className='flex mt-3 gap-1 text-base font-semibold position'><span className='flex items-center text-green-600'><BiUpArrowAlt className='text-2xl text-green-600  font-black' />37.8%</span>this month</h4>
                  </div>
                </div>
              </div>
              ...
              <div className="col-sm-3">
                <div className="well flex items-center rounded-2xl">
                  ...
                  <div className='content ml-5'>
                    ...
                    <h4 className='flex mt-3 gap-1 text-base font-semibold position'><span className='flex items-center text-green-950 text-red-600'><BiDownArrowAlt className='text-2xl' />2%</span>this month</h4>
                  </div>
                </div>
              </div>
              ...
              <div className="col-sm-3">
                <div className="well flex items-center rounded-2xl">
                  ...
                  <div className='content ml-5'>
                    ...
                    <h4 className='flex mt-3 gap-1 text-base font-semibold position'><span className='flex items-center  text-green-600'><BiUpArrowAlt className='text-2xl text-green-600 ' />11%</span>this week</h4>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Overview Start */}
              ...
              {/* Total New Customers % Chart Start */}
